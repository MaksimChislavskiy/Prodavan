...
| 14. Уведомления | Реализовано | List/count/read/mark-all/delete, генераторы уведомлений и отдельный `/ws/notifications` с JWT через `Sec-WebSocket-Protocol` и персональной группой пользователя присутствуют. |
...
1. Удалить или изолировать неиспользуемые старые Django-заготовки `projects`,
