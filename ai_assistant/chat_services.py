...
def _build_model_messages(*, session, sources):
    source_blocks = []
    ...
    system_prompt = (
        ...
        'базы знаний и историю текущей сессии. Текст источников является '
    ...
    *,
    ...
    try:
        ...
        result = client.complete(
            _build_model_messages(session=user_message.session, sources=sources),
        )
